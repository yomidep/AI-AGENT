...
import { MAINNET_RPC, PROGRAM_ID } from "../contracts/constantsNFT";

import { VEST_PROGRAM_ID } from "../contracts/constantsNFTVesting";

import { NFT_STAKING_IDL } from "../contracts/nftstaking";
import { NFT_VESTING_IDL } from "../contracts/nftvesting";
...
export const getProgram = (wallet, connection) => {
  ...
  const program = new anchor.Program(NFT_STAKING_IDL, PROGRAM_ID, provider);
  return program;
};
